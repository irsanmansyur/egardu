...
--
-- Host: localhost
-- Generation Time: Nov 04, 2021 at 12:23 PM
...
INSERT INTO `tbl_operational` (`id_operational`, `date_request`, `nama_gardu`, `pekerjaan`, `nama_user`, `time_in`, `time_out`, `id_user`, `approval_status`, `approval_at`, `approval_sp_status`, `approval_sp_at`, `action_by`, `approval_sp`, `time_waiting_cek_out`, `waiting_check_out`) VALUES
(437, '2021-11-04', 'yyyy', 'rrrr', '', '18:09:00', NULL, 124, NULL, NULL, 'waiting', NULL, NULL, NULL, NULL, 'wait');
...
(9, 2147483647, 'admin', 'admin', '', 'taufik   - approver', '202cb962ac59075b964b07152d234b70', '1', '2021-11-02', '4c96c51c27f99dcbf783e07fa86bb982.png'),
(124, 2147483647, 'adnan', 'adnan', 'Staff', 'yuda   - approver', '202cb962ac59075b964b07152d234b70', '3', '2021-11-04', '5cbc50cc40f32934e447a0334e7f0928.jpeg'),
(125, 2147483647, 'yuda', 'yuda', 'Staff', 'yuda   - approver', '202cb962ac59075b964b07152d234b70', '2', '2021-11-04', '24c62b21702bc711e120f33a49230b4e.jpeg');
...
--
ALTER TABLE `tbl_operational`
  MODIFY `id_operational` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=438;
